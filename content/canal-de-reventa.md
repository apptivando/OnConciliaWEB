# Canal de reventa: precios, servicios y comisión
...
## 1. Los comparables reales no publican precio

No hay contra qué calibrar. Los competidores funcionales directos —los
especialistas en conciliación y tesorería— venden todos con cotización.

| Producto | Alcance | Precio publicado |
|---|---|---|
| **Fonder** | Tesorería con IA: conciliación, cash flow, programación de pagos. Opera en seis países de la región | No publica |
| **Asentia** | Conciliación bancaria con IA, específica para la realidad contable argentina | No publica |
| **Conciliac** | Conciliación de bancos, tarjetas, stock, proveedores e intercompany | No publica |
| **RepoSaaS** | Conciliación bancaria y de tarjetas para Argentina y LATAM | No publica |

El silencio de precios implica dos cosas concretas. Primero, **no hay un ancla
pública que limite el precio hacia arriba**: el cliente no puede googlear una
alternativa más barata y traerla a la mesa. Segundo, en un segmento donde nadie
publica tarifa suelen circular tickets altos y venta consultiva, no productos de
cinco mil pesos por mes.

Como referencia del apetito del mercado, Fonder reporta un crecimiento superior al
40% mensual en facturación. La demanda por esta categoría existe y está pagando.

La contra es que el precio no se puede construir por comparación. Por eso el de
abajo se construye desde el valor —las horas que reemplaza— y lleva piso y techo
explícitos para negociar.

---

## 2. Posicionamiento: no competimos con el ERP, nos apoyamos en él

Las suites de gestión facturan, llevan stock y arman el balance. OnConcilia no hace
nada de eso ni pretende hacerlo. Hace la capa que esas suites resuelven a medias o
no resuelven: conciliación multi-banco real, comisiones bancarias con IVA
discriminado por alícuota, impuestos por período con cierre, préstamos, inversiones,
liquidaciones de tarjeta y Mercado Pago.

Para el referidor esto es una ventaja concreta de venta: **no tiene que desplazar
nada**. El cliente conserva su sistema de gestión y su contador. La conversación no
es «cambiate», es «esto te resuelve las horas que hoy perdés cuadrando bancos». Una
venta que no pide desinstalar nada tiene un ciclo mucho más corto y no necesita la
aprobación de quien eligió el ERP.
...
El precio de lista es la referencia y la base de cálculo de la comisión. Los dos
medios de pago aceptados llevan descuento, así que en la práctica ningún cliente
paga lista.
...
## 5. Sustento del precio: la hora diaria que se va en revisar pagos

La transferencia inmediata es hoy uno de los principales medios de cobro y pago de
una pyme argentina, y sigue creciendo: el Informe Mensual de Pagos Minoristas del
BCRA registró en julio de 2026 **777,2 millones de operaciones** por 99,5 billones
de pesos, un **22,2% más que un año antes** en cantidad. El 76,5% tuvo un CVU en
origen o destino, es decir que buena parte pasa por billeteras y no por el banco.

Eso cambia la naturaleza del trabajo administrativo. Ya no se concilia una vez por
mes contra un resumen: hay que **revisar pagos todos los días**, cruzando home
banking, billeteras y liquidaciones de tarjeta para saber qué entró y qué falta. Aun
con tres cuentas bancarias, ese trabajo no baja de una hora diaria.

De esa hora, una parte es criterio —decidir, imputar, reclamar— y no la reemplaza
ningún software. La otra parte es **puro ordenamiento**: bajar reportes, acomodarlos
...
Administrativo de categoría media, cinco años de antigüedad.

| Componente | Base de cálculo | Importe |
|---|---|---|
| Básico de convenio | CCT 130/75, escala julio 2026 | $1.270.000 |
| Antigüedad | 1% por año trabajado, cinco años | $63.500 |
| Presentismo | Artículo 40 del convenio | $111.000 |
| **Bruto mensual** | | **$1.444.500** |
| Contribuciones patronales y ART | Aproximadamente 26% sobre el bruto | $375.600 |
| Aguinaldo prorrateado | Un doceavo del bruto con cargas | $151.700 |
| **Costo empresa mensual** | | **$1.971.800** |
| **Costo por hora** | Sobre 160 horas mensuales | **$12.300** |

Los básicos son dato publicado: la escala del CCT 130/75 vigente a julio de 2026
ubica las categorías entre $1.233.585 y $1.299.445, con la suma no remunerativa de
...
|---|---|---|
| Cuenta bancaria adicional | Alta, reglas del banco y hasta 12 meses de histórico | $95.000 |
| Préstamo adicional | Alta con cuadro de amortización completo | $25.000 |
...
Dejarlo por escrito antes de firmar evita la discusión más común de toda
implementación.

- **Conseguir los extractos.** Los provee el cliente. Si hay que gestionar accesos al home banking, se cotiza como horas fuera de alcance.
- **Corregir contabilidad previa.** OnConcilia carga lo que dice el extracto; no reconstruye ni audita registros contables anteriores.
- **Integración con el ERP del cliente.** No está desarrollada. Si se pide, es un proyecto aparte con su propio presupuesto.
- **Soporte fuera de horario hábil** y capacitación de personal que ingrese después del alta.

---

## 7. Comisión del referidor

El referidor trae el cliente y Apptivando hace todo lo demás: demo, implementación,
carga, capacitación, soporte y facturación. La comisión se paga sobre el recurrente,
escalonada por cartera activa, y sobre los servicios iniciales a tasa plena.

| Clientes activos | Sobre suscripción mensual | Sobre servicios iniciales |
|---|---|---|
| 1 a 4 | 20% | 30% |
| 5 a 9 | 25% | 30% |
| **10 o más** | **30%** | **30%** |
...
### Ingreso del referidor según cartera
